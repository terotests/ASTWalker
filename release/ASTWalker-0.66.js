  ...
  var ASTWalker_prototype = function ASTWalker_prototype() {
    ...
    (function (_myTrait_) {
      ...
      _myTrait_.initSVGNamespace = function (t) {
        ...
        // tags that will be converted to DOM element access
        var _elemNamesList = ["circle", "rect", "path", "svg", "image", "line", "text", "tspan", "g", "pattern", "polygon", "polyline", "clippath", "defs", "feoffset", "femerge", "femergenode", "linearGradient", "mask", "polyline", "radialGradient", "stop", "fegaussianblur", "filter"];
        /*
              ...
              if (node.type == "JSXElement" && node.openingElement && node.openingElement.name) {
                if (node.openingElement.name.type == "JSXMemberExpression") {
                  ...
                  if (!ctx.ns) {
                    ...
                    if (node.openingElement.name.name == "svg") nameSpace = "SVG";
